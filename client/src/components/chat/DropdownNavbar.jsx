import { FaUser, FaCog, FaSignOutAlt, FaUserFriends } from 'react-icons/fa';
  ...
  return (
    <div className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-2xl bg-white">
      <div className="">
        <Link
          to="/profile"
          className="flex items-center px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-700 rounded-t-md"
          onClick={onClose}
        >
